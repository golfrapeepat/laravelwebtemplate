      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('blackend/products') }}">รายการสินค้า</a></li>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row pt-3">
                <div class="col-md-4">
                  <p><img src="{{asset('assets/blackend/images/products')}}/{{$product->image}}" class="rounded img-fluid"></p>
                </div>
